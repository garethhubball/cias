...
module.exports = {
    announce: function (client, msg, context, channel, ciasOPTS) {
    ...
    OBS_RefreshParticipants: async function (participant, ciasOPTS) {
        const obs = new OBSWebSocket();
    ...
    addParticipant: function (number, name, channel, client, ciasOPTS) {
        const db = mysql.createConnection({
            host: ciasOPTS.MYSQLhost,
            user: ciasOPTS.MYSQLuser,
            password: ciasOPTS.MYSQLpassword,
    ...
    refreshParticipantNames: function (participant, ciasOPTS) {
    ...
    updateURL: function (number, name, ciasOPTS) {
    ...
    participants: function (client, params, context, channel, ciasOPTS) {
        const db = mysql.createConnection({
            host: ciasOPTS.MYSQLhost,
            user: ciasOPTS.MYSQLuser,
            password: ciasOPTS.MYSQLpassword,
    ...
    tenseconds: function (client, ciasOPTS) {
        const db = mysql.createConnection({
            host: ciasOPTS.MYSQLhost,
            user: ciasOPTS.MYSQLuser,
            password: ciasOPTS.MYSQLpassword,
    ...
    refreshParticipants: function (params, ciasOPTS) {
        if (params[0] === `all`) {
